...
class TestSuite0001():
    ...
    def test_create_new_berms_application(self) -> None:
        data_element_action = {
            ...
            "rbtn_type_ezone": ["get_by_role_name","radio_b", "Tourism"],
    ...
    def test_create_new_berms_company_pesonal_info(self) -> None:
        data_element_action = {
            "txt_company_name": ["get_by_role_name", "textbox_a", "Company Name", "TOURISM COMPANY NAME TESTING 008"],
            "txt_nature_business": ["get_by_role_name", "textbox_a", "Nature of Business", "NATURE OF BUSINESS TOURISM COMPANY 008"],
            "txt_company_profile": ["get_by_role_name", "textbox_a", "Company Profile", "COMPANY PROFILE TOURISM COMPANY 008"],
    ...
    def test_create_new_berms_company_proposed_project(self) -> None:
        data_element_action = {
            ...
            "txt_proposed_project": ["get_by_location_fill_b", "#newBusinessProductActivity", "NEW PRODUCT ACTIVITY TOURISM COMPANY 008"],
            "btn_proposed_project_add": ["get_by_role_name", "button", " Add"],
            "txt_proposed_project_desc": ["get_by_role_name", "textbox_b", "* Description:", "NEW PRODUCT ACTIVITY TOURISM COMPANY 008 DESCRIPTION"],
            "txt_proposed_project_desc_uses": ["get_by_role_name", "textbox_b", "* Uses/Application:", "USES AND APPLICATION NEW PRODUCT ACTIVITY TOURISM COMPANY 008"],
    ...
    def test_create_new_berms_supporting_documents_0(self) -> None:
        data_element_action = {
            ...
            "add_supporing_documents1": ["get_by_file_chooser", "#dropzoneInneredt_dh10",r"Testing_document.png"],
