...
class TestSuiteBERMS001():
    ...
    def before_each_after_each(self):
        ...
        data_set = DataSetCompilationBERMS().ds_test_berms_ts005
    ...
    def test_create_new_berms_supporting_documents_1(self) -> None:
        berms.supporting_documents.file_add_certification_from_the_national(data_obj.supporting_documents.certification_from_the_national)
        berms.supporting_documents.file_add_endorsement_from_doe(data_obj.supporting_documents.endorsement_from_doe)
        berms.supporting_documents.file_add_endorsement_from_local_water_district(data_obj.supporting_documents.endorsement_from_local_water_district)

    def test_create_new_berms_supporting_documents_2(self) -> None:
        berms.supporting_documents.file_add_site_development_plan_and_vicinity_map_1(data_obj.supporting_documents.site_development_plan_and_vicinity_map_1)
        berms.supporting_documents.file_add_operation_plan_including_capacity_plan(data_obj.supporting_documents.operation_plan_including_capacity_plan)
        berms.supporting_documents.file_add_drawing_layout_support_structure_arrangement(data_obj.supporting_documents.drawing_layout_support_structure_arrangement)

    def test_create_new_berms_supporting_documents_3(self) -> None:
        berms.supporting_documents.file_add_notarized_affidavit_of_option_2(data_obj.supporting_documents.notarized_affidavit_of_option_2)
        ...
        berms.supporting_documents.file_add_certification_from_national_water_resources_board(data_obj.supporting_documents.certification_from_national_water_resources_board)
    ...
    def test_create_new_berms_supporting_documents_7(self) -> None:
