...
class TestSignUpTestSuite0001:
    ...
    def test_registration_company_info(self):
        ...
        test_page_objects.registration_company_info_name(f"COMPANY EE SOLE PROPREITORSHIP A{application_counter}")
        test_page_objects.registration_company_info_tin(F"999-999-000-{application_counter}")
    ...
    def test_registration_contact(self):
        ...
        test_page_objects.registration_company_contact_email(f"rramos.ascent+{application_counter}@gmail.com")
    ...
    def test_registration_user_credentials(self):
        test_page_objects.registration_account_info_email(f"rramos.ascent+{application_counter}@gmail.com")
        test_page_objects.registration_account_info_uname(f"TESTAT{application_counter}")
