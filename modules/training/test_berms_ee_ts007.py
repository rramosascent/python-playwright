...
class TestSuiteBERMS001():
    ...
    def before_each_after_each(self):
        ...
        data_set = DataSetCompilationBERMS().ds_test_berms_ts007
    ...
    def test_create_new_berms_supporting_documents_1(self) -> None:
        ...
        berms.supporting_documents.file_add_endorsement_dot_and_doh(data_obj.supporting_documents.endorsement_dot_and_doh)
