...
class TestSuite0001():
    ...
    def test_create_new_berms_company_pesonal_info(self) -> None:
        data_element_action = {
            "txt_company_name": ["get_by_role_name", "textbox_a", "Company Name", "UTILITIES COMPANY NAME TESTING 002"],
            "txt_nature_business": ["get_by_role_name", "textbox_a", "Nature of Business", "NATURE OF BUSINESS UTILITIES COMPANY 002"],
            "txt_company_profile": ["get_by_role_name", "textbox_a", "Company Profile", "COMPANY PROFILE UTILITIES COMPANY 002"],
    ...
    def test_create_new_berms_company_proposed_project(self) -> None:
        data_element_action = {
            ...
            "txt_proposed_project": ["get_by_location_fill_b", "#newBusinessProductActivity", "NEW PRODUCT ACTIVITY UTILITIES COMPANY 002"],
            "btn_proposed_project_add": ["get_by_role_name", "button", " Add"],
            "txt_proposed_project_desc": ["get_by_role_name", "textbox_b", "* Description:", "NEW PRODUCT ACTIVITY UTILITIES COMPANY 002 DESCRIPTION"],
            "txt_proposed_project_desc_uses": ["get_by_role_name", "textbox_b", "* Uses/Application:", "USES AND APPLICATION NEW PRODUCT ACTIVITY UTILITIES COMPANY 002"],
