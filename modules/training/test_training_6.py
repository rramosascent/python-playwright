...
class TestSuite0001():
    ...
    def test_create_new_berms_application(self) -> None:
        data_element_action = {
            ...
            "rbtn_type_ezone": ["get_by_role_name","radio_b", "Utilities"],
    ...
    def test_create_new_berms_company_pesonal_info(self) -> None:
        data_element_action = {
            "txt_company_name": ["get_by_role_name", "textbox_a", "Company Name", "UTILITIES COMPANY NAME TESTING 011"],
            "txt_nature_business": ["get_by_role_name", "textbox_a", "Nature of Business", "NATURE OF BUSINESS UTILITIES COMPANY 011"],
            "txt_company_profile": ["get_by_role_name", "textbox_a", "Company Profile", "COMPANY PROFILE UTILITIES COMPANY 010110"],
    ...
    def test_create_new_berms_company_proposed_project(self) -> None:
        data_element_action = {
            ...
            "txt_proposed_project": ["get_by_location_fill_b", "#newBusinessProductActivity", "NEW PRODUCT ACTIVITY UTILITIES COMPANY 011"],
            "btn_proposed_project_add": ["get_by_role_name", "button", " Add"],
            "txt_proposed_project_desc": ["get_by_role_name", "textbox_b", "* Description:", "NEW PRODUCT ACTIVITY UTILITIES COMPANY 011 DESCRIPTION"],
            "txt_proposed_project_desc_uses": ["get_by_role_name", "textbox_b", "* Uses/Application:", "USES AND APPLICATION NEW PRODUCT ACTIVITY UTILITIES COMPANY 011"],
    ...
    def test_create_new_berms_supporting_documents_0(self) -> None:
        data_element_action = {
            "add_supporing_documents": ["get_by_file_chooser", "#dropzoneInnerCN18",r"Testing_document.png"],
            "add_supporing_documents1": ["get_by_file_chooser", "#dropzoneInnerFEDOE17",r"Testing_document.png"],
            "add_supporing_documents2": ["get_by_file_chooser", "#dropzoneInnerFELWD16",r"Testing_document.png"]
        }
        self.initiate_test_data().data_processing_func_peza(data_element_action)
    ...
    def test_create_new_berms_supporting_documents_1(self) -> None:
        data_element_action = {
            "add_supporing_documents": ["get_by_file_chooser", "#dropzoneInnerSDPVM15",r"Testing_document.png"],
            "add_supporing_documents1": ["get_by_file_chooser", "#dropzoneInnerCOP14",r"Testing_document.png"],
            "add_supporing_documents2": ["get_by_file_chooser", "#dropzoneInnerSSA13",r"Testing_document.png"]
        }
        self.initiate_test_data().data_processing_func_peza(data_element_action)

    def test_create_new_berms_supporting_documents_2(self) -> None:
        data_element_action = {
            "add_supporing_documents": ["get_by_file_chooser", "#dropzoneInnernao12",r"Testing_document.png"],
            "add_supporing_documents1": ["get_by_file_chooser", "#dropzoneInnernwrc11",r"Testing_document.png"],
    ...
    def test_create_new_berms_supporting_documents_6(self) -> None:
        data_element_action = {
