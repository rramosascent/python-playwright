...
from modules.testcases.ptops.data_objects.ptops_data_sets import DataSetCompilationSignUpEE
...
class TestSignUpTestSuite0001:
    ...
    def before_each_after_each(self):
        ...
        reg_data = DataSetCompilationSignUpEE().ds_test_sign_ee_ts004
    ...
    def test_registration_sup_docs_cda_registration(self):
        test_page_objects.registration_supporting_documents(reg_data_obj.select_supporting_docs_1)
